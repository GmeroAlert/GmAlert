...
const Icons = [
  ...
  '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M1.5,1.5l21,21" style="fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:3px"/><path d="M1.5,22.5l21-21" style="fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:3px"/></svg>',
]

export function svgIcon(index: number, className = '') {
  return `<i class="${styles.icon} ${className} ${
    index === 5 ? styles.close : ''
  }">${Icons[index]}</i>`
}
