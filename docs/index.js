var GmAlert = (function (exports) {
  ...
  const getCenterRoot = () => {
    let $root = document.querySelector(`.${styles$6['gmsg-wrapper-center']}`);
    if ($root) return $root;
    $root = newDiv(styles$6['gmsg-wrapper-center']);
  ...
  const getTopRightRoot = () => {
    ...
    const $wrapper = newDiv(styles$6['gmsg-wrapper-top-right']);
  ...
  const getAlertContariner = () => {
    let $wrapper = document.querySelector(`.${styles$6['gmsg-wrapper-center-alert']}`);
    if ($wrapper) return $wrapper;
    $wrapper = newDiv(styles$6['gmsg-wrapper-center-alert']);
    getContainer().append($wrapper);
    return $wrapper;
  };
  const getRoot = (position = 'center') => {
    switch (position) {
      case 'center':
  ...
  var css_248z$3 = ".alert___Su0Xe {\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  min-width: 350px;\n  padding: 1rem;\n  pointer-events: all;\n  background-color: #fff;\n  border-radius: 5px;\n  box-shadow: 0 0 1px rgba(0, 0, 0, 0.075), 0 1px 2px rgba(0, 0, 0, 0.075), 1px 2px 4px rgba(0, 0, 0, 0.075), 1px 3px 8px rgba(0, 0, 0, 0.075), 2px 4px 16px rgba(0, 0, 0, 0.075);\n  animation: alert-show___fKZw2 0.3s;\n  animation-fill-mode: both;\n}\n.alert___Su0Xe.is-opening___LZKyT, .alert___Su0Xe.is-closing___OYm2- {\n  pointer-events: none;\n}\n\n.alert-icon___Wi1df {\n  margin: 0 auto;\n}\n\n.alert-button-container___BKNWF {\n  display: flex;\n  justify-content: center;\n  margin-top: 1rem;\n}\n.alert-button-container___BKNWF .alert-button___BHq1U {\n  padding: 0.625em 1.1em;\n  margin: 0.3125em;\n  font-size: 1em;\n  font-weight: 500;\n  color: #fff;\n  cursor: pointer;\n  background: transparent none repeat 0 0 / auto auto padding-box border-box scroll;\n  background: initial;\n  background-color: #7066e0;\n  border: 0;\n  border-radius: 0.25em;\n}\n.alert-button-container___BKNWF .alert-button___BHq1U:hover {\n  background-image: linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1));\n}\n\n.alert-content___3l0Cr {\n  z-index: 1;\n  margin: 1em 1.6em 0.3em;\n  overflow: auto;\n  font-size: 1.125em;\n  color: inherit;\n  text-align: center;\n  word-break: break-word;\n  word-wrap: break-word;\n}\n\n.alert-title___-WvmC {\n  position: relative;\n  max-width: 100%;\n  padding: 0.8em 1em 0;\n  margin: 0;\n  font-size: 1.875em;\n  font-weight: 600;\n  color: inherit;\n  text-align: center;\n  text-transform: none;\n  word-wrap: break-word;\n}\n\n.alert-close___vIbaH {\n  position: absolute;\n  top: 4px;\n  right: 4px;\n  font-size: 20px;\n  cursor: pointer;\n}\n\n@keyframes alert-show___fKZw2 {\n  0% {\n    transform: scale(0.7);\n  }\n  45% {\n    transform: scale(1.05);\n  }\n  80% {\n    transform: scale(0.95);\n  }\n  100% {\n    transform: scale(1);\n  }\n}\n@keyframes alert-hide___ZbDx6 {\n  0% {\n    opacity: 1;\n    transform: scale(1);\n  }\n  100% {\n    opacity: 0;\n    transform: scale(0.5);\n  }\n}";
  var styles$3 = {"alert":"alert___Su0Xe","alert-show":"alert-show___fKZw2","is-opening":"is-opening___LZKyT","is-closing":"is-closing___OYm2-","alert-icon":"alert-icon___Wi1df","alert-button-container":"alert-button-container___BKNWF","alert-button":"alert-button___BHq1U","alert-content":"alert-content___3l0Cr","alert-title":"alert-title___-WvmC","alert-close":"alert-close___vIbaH","alert-hide":"alert-hide___ZbDx6"};
  ...
  function Button(text, onClick) {
    ...
    $btn.onclick = onClick;
    $btn.classList.add(styles$3['alert-button']);
    return $btn;
  }
  function GmAlert(props) {
    ...
    const open = () => {
      ...
      return new Promise(resolve => {
        const handle = e => {
          if (e.animationName === styles$3['alert-show']) {
    ...
    const close = () => {
      ...
      return new Promise(resolve => {
        const handle = e => {
          if (e.animationName === styles$3['alert-hide']) {
            $wrapper.remove();
            if (props.onClosed) {
              props.onClosed();
            }
    ...
    if (props.onCancel || props.onConfirm) {
      const $buttons = newDiv(styles$3['alert-button-container']);
      if (props.onCancel) {
  ...
  function GmInfomation(props) {
    ...
    const open = () => {
      ...
      return new Promise(resolve => {
        setTimeout(() => {
          const handle = e => {
            if (e.animationName === styles$2['infomation-move-in']) {
              $wrapper.removeEventListener('animationend', handle);
              resolve();
            }
          };
    ...
    const close = () => {
      return new Promise(resolve => {
        ...
        const handle = e => {
          if (e.animationName === styles$2['infomation-move-out']) {
            $wrapper.remove();
            resolve();
          }
        };
  ...
  function GmMessage(props) {
    ...
    $wrapper.append($main);
    $main.innerHTML = `${icon}<div class=${styles$1['message-content']}>${props.text}</div>`;
    const open = () => {
  ...
  var css_248z = "@charset \"UTF-8\";\n.notice-wrapper___v2pJw {\n  position: relative;\n  width: 20rem;\n  margin-bottom: 1rem;\n  background: #fff;\n  border-radius: 5px;\n  box-shadow: 0 0 1px rgba(0, 0, 0, 0.075), 0 1px 2px rgba(0, 0, 0, 0.075), 1px 2px 4px rgba(0, 0, 0, 0.075), 1px 3px 8px rgba(0, 0, 0, 0.075), 2px 4px 16px rgba(0, 0, 0, 0.075);\n  transform-origin: top center;\n  animation-duration: 0.25s;\n}\n.notice-wrapper___v2pJw .notice-main___YXiGH {\n  display: flex;\n  flex-direction: column;\n  align-items: normal;\n}\n.notice-wrapper___v2pJw .notice-main___YXiGH .notice-content___ysok2 {\n  position: relative;\n  margin: 1rem 1rem 1.2rem 3.4rem;\n}\n.notice-wrapper___v2pJw .notice-icon___MvUBU {\n  position: absolute;\n  top: 0.7rem;\n  left: 1rem;\n}\n\n/* notice进入 */\n@keyframes notice-movein___M8YUM {\n  0% {\n    opacity: 0;\n    transform: translateX(100%);\n  }\n  50% {\n    opacity: 0.75;\n  }\n  100% {\n    opacity: 1;\n    transform: translateX(0);\n  }\n}\n/* notice退出 */\n@keyframes notice-moveout___vwgYy {\n  0% {\n    opacity: 1;\n  }\n  60% {\n    opacity: 0;\n    transform: translateX(100%);\n  }\n  100% {\n    max-height: 0;\n    margin: 0;\n    opacity: 0;\n  }\n}";
  var styles = {"notice-wrapper":"notice-wrapper___v2pJw","notice-main":"notice-main___YXiGH","notice-content":"notice-content___ysok2","notice-icon":"notice-icon___MvUBU","notice-movein":"notice-movein___M8YUM","notice-moveout":"notice-moveout___vwgYy"};
  ...
  class Msg {
    ...
    // 设置进度
    setProgress(pause = false, reset = false) {
      if (!this.timeout) return;
      let $progress = this.$elem.querySelector(`.${styles$6['gmsg-progress']}`);
      let $progressBar = this.$elem.querySelector(`.${styles$6['gmsg-progress-bar']}`);
      ...
      if (pause) {
        ...
        setTimeout(() => {
          ...
          $progressBar.style.transition = `width ${this.timeout * this.progress}ms linear`;
        }, 10);
      }
    }
    ...
    getProgress() {
      ...
      const $progress = this.$elem.querySelector(`.${styles$6['gmsg-progress']}`);
      const $progressBar = this.$elem.querySelector(`.${styles$6['gmsg-progress-bar']}`);
