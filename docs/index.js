(function () {
  ...
  function animationendHandle($el, handle) {
    ...
    EventHandler$1.on($el, 'animationend', animationend);
  }
  ...
  function GmAlert(props) {
    ...
    const close = async status => {
      ...
      EventHandler$1.off($overlay, 'click', overlayClick);
    ...
    const open = () => {
      EventHandler$1.on(overLaySwitch(true), 'click', overlayClick);
  ...
  const AlertBtnBox = BtnBox(Button('Normal Alert', NormalAlert), Button('Alert With Content', AlertWithContent), Button('Alert With Button', AlertWithButton), Button('Alert With Html', AlertwithHtml));
  var AlertBtnBox$1 = AlertBtnBox;
  ...
  var NoticeBtnBox$1 = NoticeBtnBox;
  ...
  AlertArea.append(AlertBtnBox$1);
  const MessageArea = Area('Message');
  MessageArea.append(MsgBtnBox$1);
  const NoticeArea = Area('Notice');
  NoticeArea.append(NoticeBtnBox$1);
